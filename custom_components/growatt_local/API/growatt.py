...
from .device_type.storage_120 import STORAGE_HOLDING_REGISTERS_120, STORAGE_INPUT_REGISTERS_120, STORAGE_INPUT_REGISTERS_120_TL_XH, STORAGE_INPUT_REGISTERS_SPH_10000_CUSTOM
...
def get_register_information(GrowattDeviceType: DeviceTypes) -> DeviceRegisters:
    if GrowattDeviceType in (DeviceTypes.INVERTER, DeviceTypes.INVERTER_315):
    ...
    elif GrowattDeviceType == DeviceTypes.SPH_10000_CUSTOM:
        max_length = MAXIMUM_DATA_LENGTH_120
        holding_register = {
            obj.register: obj for obj in STORAGE_HOLDING_REGISTERS_120
        }
        ...
        input_register.update({
            obj.register: obj for obj in STORAGE_INPUT_REGISTERS_SPH_10000_CUSTOM
        })
