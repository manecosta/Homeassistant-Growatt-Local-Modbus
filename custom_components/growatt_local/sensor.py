...
async def async_setup_entry(
    ...
    if device_type in (DeviceTypes.INVERTER, DeviceTypes.INVERTER_315, DeviceTypes.INVERTER_120,
                       DeviceTypes.HYBRID_120, DeviceTypes.HYBRID_120_TL_XH, DeviceTypes.SPH_10000_CUSTOM):
    ...
    if device_type in (DeviceTypes.HYBRID_120, DeviceTypes.HYBRID_120_TL_XH, DeviceTypes.STORAGE_120, DeviceTypes.SPH_10000_CUSTOM):
    ...
    elif device_type in (DeviceTypes.HYBRID_120, DeviceTypes.HYBRID_120_TL_XH, DeviceTypes.SPH_10000_CUSTOM):
        power_sensor = (ATTR_INPUT_POWER, ATTR_OUTPUT_POWER,
